...
export PATH=/opt/homebrew/opt/gnu-sed/libexec/gnubin:${BUILD_PREFIX}/bin:${HOME}/.bin:/usr/local/bin:${HOME}/.cargo/bin:${HOME}/bin:${GOPATH}/bin:${HOME}/.npm-packages/bin:/opt/homebrew/sbin:${PATH}:$HOME/Applications/PyCharm.app/Contents/MacOS:/opt/homebrew/opt/grep/libexec/gnubin:/opt/homebrew/opt/curl/bin:/opt/homebrew/opt/make/libexec/gnubin:/opt/homebrew/opt/coreutils/libexec/gnubin:/opt/homebrew/opt/sqlite/bin:$HOME/.rd/bin:${HOME}/.config/emacs/bin
