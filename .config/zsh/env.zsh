...
export PATH=${BUILD_PREFIX}/bin:${HOME}/.bin:${HOME}/.local/share/bob/nvim-bin:/usr/local/bin:${HOME}/.cargo/bin:${HOME}/bin:${GOPATH}/bin:${HOME}/.npm-packages/bin:${PATH}:$HOME/Applications/PyCharm.app/Contents/MacOS:/opt/homebrew/opt/grep/libexec/gnubin:/opt/homebrew/opt/curl/bin:/opt/homebrew/opt/make/libexec/gnubin:/opt/homebrew/opt/gnu-sed/libexec/gnubin:/opt/homebrew/opt/coreutils/libexec/gnubin:/opt/homebrew/opt/sqlite/bin:/opt/homebrew/bin
