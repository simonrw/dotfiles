...
status is-interactive; and begin
    ...
    set -x PATH {$BUILD_PREFIX}/bin {$HOME}/.bin /opt/homebrew/bin /opt/homebrew/opt/coreutils/libexec/gnubin /usr/local/bin {$HOME}/.cargo/bin {$HOME}/bin {$GOPATH}/bin {$HOME}/.npm-packages/bin {$PATH}
