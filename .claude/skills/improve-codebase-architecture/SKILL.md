...
### 7. Create markdown file with notes

Create a markdown document in the project root directory called `REFACTORING.md`. Use the template in [REFERENCE.md](REFERENCE.md). Do NOT ask the user to review before creating — just create it.
