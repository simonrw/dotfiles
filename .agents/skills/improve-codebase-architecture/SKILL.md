...
- `mcp__linear-server__save_issue` — create the refactor RFC issue
...
Create a refactor RFC as a Linear issue using `mcp__linear-server__save_issue`. Use the template in [REFERENCE.md](REFERENCE.md). Do NOT ask the user to review before creating — just create it and share the identifier.
