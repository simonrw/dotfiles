...
c.SSHEngineSetLauncher.engine_cmd = [
    '/home/astro/phsnag/anaconda/envs/cluster/bin/ipengine']
...
# c.IPClusterStart.work_dir = '/Users/simon/work/WASP/ComparisonWithFressin'
...
# Set the working dir for the process.
# c.IPClusterEngines.work_dir = '/Users/simon/work/WASP/ComparisonWithFressin'
...
# c.LocalControllerLauncher.controller_cmd = ['/Users/simon/work/WASP/ComparisonWithFressin/venv/bin/python', '-m', 'IPython.parallel.controller']
...
# c.LocalEngineLauncher.engine_cmd = ['/Users/simon/work/WASP/ComparisonWithFressin/venv/bin/python', '-m', 'IPython.parallel.engine']
...
# command to launch the Engine.
# c.LocalEngineSetLauncher.engine_cmd = ['/Users/simon/work/WASP/ComparisonWithFressin/venv/bin/python', '-m', 'IPython.parallel.engine']
...
# Popen command to launch ipcontroller.
# c.MPIControllerLauncher.controller_cmd = ['/Users/simon/work/WASP/ComparisonWithFressin/venv/bin/python', '-m', 'IPython.parallel.controller']
...
# command to launch the Engine.
# c.MPIEngineSetLauncher.engine_cmd = ['/Users/simon/work/WASP/ComparisonWithFressin/venv/bin/python', '-m', 'IPython.parallel.engine']
...
# Popen command to launch ipcontroller.
# c.SSHControllerLauncher.controller_cmd = ['/Users/simon/work/WASP/ComparisonWithFressin/venv/bin/python', '-m', 'IPython.parallel.controller']
...
# command to launch the Engine.
# c.SSHEngineLauncher.engine_cmd = ['/Users/simon/work/WASP/ComparisonWithFressin/venv/bin/python', '-m', 'IPython.parallel.engine']
...
# command to launch the Engine.
# c.SSHEngineSetLauncher.engine_cmd = ['/Users/simon/work/WASP/ComparisonWithFressin/venv/bin/python', '-m', 'IPython.parallel.engine']
